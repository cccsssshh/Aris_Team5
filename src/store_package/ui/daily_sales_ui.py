...
# Form implementation generated from reading ui file '/home/addinedu/amr_ws/aris_team5/Aris_Team5/src/store_package/ui/daily_sales.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(867, 662)
        self.stackedWidget = QtWidgets.QStackedWidget(Dialog)
        self.stackedWidget.setGeometry(QtCore.QRect(40, 30, 791, 581))
        self.stackedWidget.setObjectName("stackedWidget")
        self.page = QtWidgets.QWidget()
        self.page.setObjectName("page")
        self.dailySalesTable = QtWidgets.QTableWidget(self.page)
        self.dailySalesTable.setGeometry(QtCore.QRect(10, 40, 611, 431))
        ...
        self.menuSalesGraph.setGeometry(QtCore.QRect(40, 40, 691, 491))
        self.menuSalesGraph.setText("")
        self.menuSalesGraph.setObjectName("menuSalesGraph")
        self.stackedWidget.addWidget(self.page_2)
        self.page_3 = QtWidgets.QWidget()
        self.page_3.setObjectName("page_3")
        self.hourlySalesGraph = QtWidgets.QLabel(self.page_3)
        self.hourlySalesGraph.setGeometry(QtCore.QRect(60, 50, 671, 471))
        self.hourlySalesGraph.setText("")
        self.hourlySalesGraph.setObjectName("hourlySalesGraph")
        ...
        self.hourlySalesRBtn = QtWidgets.QRadioButton(self.layoutWidget)
        self.hourlySalesRBtn.setObjectName("hourlySalesRBtn")
        self.horizontalLayout.addWidget(self.hourlySalesRBtn)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.hourlySalesRBtn.setText(_translate("Dialog", "시간대별"))
